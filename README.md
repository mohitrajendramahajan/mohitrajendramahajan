...
* Deepening expertise in **ANNs** (Artificial Neural Networks) and **LLMs** (Large Language Models).
* Building end-to-end Machine Learning pipelines, focusing on **ETL (Extract, Transform, Load)** processes.
...
| **ML/Deep Learning**| `TensorFlow`, `Sk-learn`, `NumPy`, `ANNs`, `LLMs` |
| **Data & ETL** | `Pandas`, `SQL`, `BigQuery`, `Data Wrangling`, `ETL` |
